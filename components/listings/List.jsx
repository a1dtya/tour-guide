              ...
              {isDateOpen && (
                <div className="accordion-body">
                  <div className="list-accordian-option-date">
                    ...
                    <input type="date"  value={todayDate} id="option1"  onChange={handleDateChange}  className="date-box" />
                  </div>
          ...
          <div className="tour-list-main-right-cards-wrapper">
            <div className="tour-list-main-card">
              <div className="tour-list-main-card-left-info">
                <div className="tour-list-main-card-left-info-image">
                  <Image
                    src={"/assets/media/list/london/london1.png"}
                    alt="london1"
                    width={150}
                    height={140}
                  />
                ...
                <div className="tour-list-main-card-left-info-details">
                  ...
                  <div className="tour-list-main-card-left-info-details-middle">
                    <h4>Westminster to Greenwich River Thames</h4>
                  </div>

                  <div className="tour-list-main-card-left-info-details-bottom">
                    <span>
                      {" "}
                      <MdOutlineAccessTime />2 hours{" "}
                    </span>
                    <span>
                      {" "}
                      <FaCarSide /> Transport{" "}
            ...
            <div className="tour-list-main-card">
              <div className="tour-list-main-card-left-info">
                <div className="tour-list-main-card-left-info-image">
                  <Image
                    src={"/assets/media/list/london/london2.png"}
                    alt="london1"
                    width={150}
                    height={140}
                  />
            ...
            <div className="tour-list-main-card">
              <div className="tour-list-main-card-left-info">
                <div className="tour-list-main-card-left-info-image">
                  <Image
                    src={"/assets/media/list/london/london3.png"}
                    alt="london1"
                    width={150}
                    height={140}
                  />
            ...
            <div className="tour-list-main-card">
              <div className="tour-list-main-card-left-info">
                <div className="tour-list-main-card-left-info-image">
                  <Image
                    src={"/assets/media/list/london/london4.png"}
                    alt="london1"
                    width={150}
                    height={140}
                  />
            ...
            <div className="tour-list-main-card">
              <div className="tour-list-main-card-left-info">
                <div className="tour-list-main-card-left-info-image">
                  <Image
                    src={"/assets/media/list/london/london5.png"}
                    alt="london1"
                    width={150}
                    height={140}
                  />
            ...
            <div className="tour-list-main-cards-more">
              <p>Load More</p>
            </div>
          </div>
        </div>
...
//         <IoMdStar />
//       </p>
//       <p className="text-[12px]">548 reviews</p>
//     </div>
